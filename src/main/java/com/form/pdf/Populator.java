...
public class Populator {
	...
	public static void main(String[] args) {
		...
		String originalPdf = "C:\\Users\\nkumar136\\Downloads\\_ScannedDocument.PDF";
		String targetPdf = "C:\\Users\\nkumar136\\Downloads\\_ScannedDocument_target.pdf";
	...
	private static void populateAndCopy(String originalPdf, String targetPdf) throws IOException, COSVisitorException {
		...
		setField("topmostSubform[0].Page1[0].f1_6[0]","104 Heritage Rd #1\nGuilderland, NY 12084");
		setField("topmostSubform[0].Page1[0].f1_8[0]", "2626226783");
		setField("topmostSubform[0].Page1[0].f1_9[0]", "NP1010");
    ...
    public static void setField(String name, String value ) throws IOException {
        ...
        if( field != null ) {
        	System.out.println("current value of ["+name+"]:"+field.getValue());
